...
class KlipperScreenConfig:
    ...
    def validate_config(self):
        ...
        for section in self.config:
            ...
            if section == 'main':
                ...
                numbers = (
                    'job_complete_timeout', 'job_error_timeout', 'move_speed_xy', 'move_speed_z', "ret_length", "ret_speed", "tube_length_extr1", "tube_length_extr2", "unret_extra_length", "unret_speed",
    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options.extend(panel_options)
                ...
                ############ Added new items for filament settings ########################
        
        filament_options = [
            {"ret_length": {"section": "main", "name": ("Retraction Length"), "units": ("mm"), "type": None, "value": "20", "digits": 0, "maxval":500}},
            {"ret_speed": {"section": "main", "name": ("Retract Speed"), "units": ("mm/s"), "type": None, "value": "50", "digits": 0, "maxval":100}},
            {"tube_length_extr1": {"section": "main", "name": ("Tube length extruder 0"), "utils": ("mm"), "type": None, "value": "1165", "digits": 0, "maxval":4000}},
            {"tube_length_extr2": {"section": "main", "name": ("Tube length extruder 1"), "units": ("mm"), "type": None, "value": "1165", "digits": 0, "maxval":4000}},
            {"unret_extra_length": {"section": "main", "name": ("Unretract Extra Length"), "units": ("mm"), "type": None, "value": "50", "digits": 0, "maxval":150}},
            {"unret_speed": {"section": "main", "name": ("Unretract Speed"), "utils": ("mm/s"), "type": None, "value": "10", "digits": 0, "maxval":100}}
        ]

        self.configurable_options.extend(filament_options)

        ############ end Added new items for filament settings ########################
